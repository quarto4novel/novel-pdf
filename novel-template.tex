...
\textsc{\theTitle}\par
\par
$if(copyright.mention)$$copyright.mention$\par$else$Copyright ©$year$ \theAuthor.\par$endif$
$if(copyright.rights)$$copyright.rights$\par$else$All Rights Reserved.\par$endif$
\null
...
Independently Published by \theAuthor,\par % Publisher is you, not the print/distribution service.
