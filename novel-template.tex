...
\textsc{\theTitle}\par
\par
$if(copyright.mention)$$copyright.mention$$else$Copyright ©$copyright.year$ \theAuthor.$endif$\par
$if(copyright.rights)$$copyright.rights$$else$All Rights Reserved.$endif$\par
\null
$if(fiction-mention)$
$fiction-mention$\par
$else$
...
$if(publisher.self-published)$Independently $endif$Published by $publisher.name$,\par
$publisher.location$\par
$if(publisher.online-contact)$
$publisher.online-contact$\par
$endif$
$if(publisher.catalog-mention)$
\null
$publisher.catalog-mention$\par
$endif$
} % end itshape
\end{center}
\clearpage
