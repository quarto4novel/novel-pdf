...
{{< quickchapter "1. Inline formatting" >}}
...
{{< quickchapter "3. Basic math integration" >}}
...
{{< quickchapter "5. Scene breaks" >}}

Here are some `scenebreak` shortcodes of different types:
